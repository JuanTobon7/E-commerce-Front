<template>
    <footer class="flex sm:h-auto p-3 bg-gradient-to-br from-primary-500 to-primary-400">
        <section class="ctn w-full md:h-40 py-">
            ...
            <div class="card">
                <h2>Siguenos</h2>
                <ul  class="text-primary-800">
                    <li>
                        <a class="hover:cursor-pointer flex gap-1"  href="https://www.facebook.com/ColegioPedagogicoTeresitaVidal" target="_blank">
                    ...
                    <li>
                        <a class="hover:cursor-pointer flex gap-1" href="https://www.instagram.com/terevidal_school/" target="_blank"><svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="card">
                <h2>Ubicacion</h2>
                <a class="text-primary-800 flex gap-1 hover:cursor-pointer" href="https://maps.app.goo.gl/ACkF6okL36dtAhBx5" target="_blank">
                    <i class="material-symbols-outlined">pin_drop</i>
                    Carrera 16A este N° 22b – 63 sur
                </a>
            </div>
            <div class="card">
                <h2>Contactanos</h2>
                <a class="hover:cursor-pointer text-primary-800 flex gap-1" href="https://wa.me/3227617424" target="_blank"><i class="material-symbols-outlined">call</i>3227617424</a>
...
<style scoped>
.ctn{
 @apply container grid grid-cols-1 md:grid-cols-4 gap-4;
}
.card h2{
    @apply text-2xl text-primary-100;
}
.card{
